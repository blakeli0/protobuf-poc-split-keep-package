...
/** A factory for message info based on protobuf descriptors for a {@link GeneratedMessageV4}. */
@ExperimentalApi
final class DescriptorMessageInfoFactory implements MessageInfoFactory {
  ...
  public boolean isSupported(Class<?> messageType) {
    return GeneratedMessageV4.class.isAssignableFrom(messageType);
  }

  @Override
  public MessageInfo messageInfoFor(Class<?> messageType) {
    if (!GeneratedMessageV4.class.isAssignableFrom(messageType)) {
