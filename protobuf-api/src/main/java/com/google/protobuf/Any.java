...
private static final long serialVersionUID = 0L;
  ...
  private Any(com.google.protobuf.FlattenedGeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private Any() {
    typeUrl_ = "";
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.FlattenedGeneratedMessageV3.isStringEmpty(typeUrl_)) {
      com.google.protobuf.FlattenedGeneratedMessageV3.writeString(output, 1, typeUrl_);
    }
    if (!value_.isEmpty()) {
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.FlattenedGeneratedMessageV3.isStringEmpty(typeUrl_)) {
      size += com.google.protobuf.FlattenedGeneratedMessageV3.computeStringSize(1, typeUrl_);
    }
    if (!value_.isEmpty()) {
